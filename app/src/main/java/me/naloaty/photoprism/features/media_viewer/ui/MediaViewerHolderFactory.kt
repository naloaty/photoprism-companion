...
import me.naloaty.photoprism.features.media_viewer.ui.items.ImageItemViewHolder
import me.naloaty.photoprism.features.media_viewer.ui.items.VideoItemViewHolder
import ru.tinkoff.mobile.tech.ti_recycler.base.BaseViewHolder
import ru.tinkoff.mobile.tech.ti_recycler_coroutines.base.CoroutinesHolderFactory

class MediaViewerHolderFactory(
    private val videoPlayerCache: VideoPlayerCache,
    private val requestManager: RequestManager
): CoroutinesHolderFactory() {
    override fun createViewHolder(view: View, viewType: Int): BaseViewHolder<*>? {
        return when (viewType) {
            R.layout.page_picture_preview -> ImageItemViewHolder(view, requestManager)
            ...
            R.layout.page_video -> VideoItemViewHolder(view, videoPlayerCache)
