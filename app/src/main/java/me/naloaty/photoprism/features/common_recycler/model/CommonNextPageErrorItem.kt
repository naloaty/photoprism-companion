...
import me.naloaty.photoprism.databinding.LayoutCommonNextPageErrorBinding
...
data object CommonNextPageErrorItem : ViewTyped {
    ...
    override val viewType: Int = R.layout.layout_common_next_page_error
}
...
class CommonNextPageErrorItemViewHolder(view: View, clicks: TiRecyclerClickListener) :
    ...
    private val binding = LayoutCommonNextPageErrorBinding.bind(view)
