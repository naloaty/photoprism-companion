...
import me.naloaty.photoprism.databinding.LayoutVideoPlayerControlsBinding
import me.naloaty.photoprism.features.media_viewer.ui.items.VideoItem


fun VideoPlayerViewHolder(playerView: PlayerView): VideoPlayerViewHolder {
    return VideoPlayerViewHolderImpl(playerView)
}
...
interface VideoPlayerViewHolder {
    ...
    fun setOnFatalPlaybackErrorListener(listener: (item: VideoItem) -> Unit)
    fun enableFatalPlaybackErrorListener(item: VideoItem)
...
class VideoPlayerViewHolderImpl(
    ...
    private var fatalPlaybackErrorListener: (VideoItem) -> Unit = {}
    ...
    override fun setOnFatalPlaybackErrorListener(listener: (source: VideoItem) -> Unit) {
        fatalPlaybackErrorListener = listener
    }

    override fun enableFatalPlaybackErrorListener(item: VideoItem) {
